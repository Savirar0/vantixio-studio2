...
export default function Dock({
  ...
  return (
    <motion.div
      ...
      className={`fixed bottom-4 left-1/2 transform -translate-x-1/2 hidden lg:flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4 z-50 text-white ${className}`} 
      style={{ height }}
      role="toolbar"
